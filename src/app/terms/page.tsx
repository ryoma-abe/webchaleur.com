      ...
      <div className="container mx-auto px-4 py-12">
        <FadeIn>
          <div className="max-w-4xl mx-auto">
            ...
            <SubHeading>第1条（適用）</SubHeading>
            <p className="text-gray mb-6">
              本規約は、ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。
            </p>

            <SubHeading>第2条（利用登録）</SubHeading>
            <p className="text-gray mb-6">
              本サービスにおいては、登録希望者が本規約に同意の上、当社の定める方法によって利用登録を申請し、
              当社がこれを承認することによって、利用登録が完了するものとします。
            </p>

            <SubHeading>第3条（サービス内容）</SubHeading>
            <p className="text-gray mb-6">
              当社は、以下のサービスを提供いたします：
            </p>
            ...
            <SubHeading>第4条（料金および支払方法）</SubHeading>
            <p className="text-gray mb-6">
              ユーザーは、本サービスの利用にあたり、当社が別途定める料金を、
              当社が指定する方法により支払うものとします。
            </p>

            <SubHeading>第5条（禁止事項）</SubHeading>
            <p className="text-gray mb-6">
            ...
            <SubHeading>第8条（サービス内容の変更等）</SubHeading>
            <p className="text-gray mb-6">
