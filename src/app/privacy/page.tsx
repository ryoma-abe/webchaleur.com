      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <SketchyCard className="mb-8">
          <div className="prose prose-lg max-w-none font-zenmaru">
            ...
            <h2 className="text-xl font-klee font-bold text-text-dark mt-8 mb-4">
              1. 個人情報の定義
            </h2>
            <p className="text-text-gray mb-6">
            ...
            <ul className="list-disc pl-6 text-text-gray mb-6">
            ...
            <div className="bg-accent-beige/30 p-4 rounded-2xl">
              <p className="text-text-gray">
                ...
                お問い合わせフォーム: <a href="/contact" className="text-main-blue hover:underline">こちら</a>
              </p>
            </div>
