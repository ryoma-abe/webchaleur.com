...
padding: 18px 35px 16px 38px;
transform: rotate(-0.2deg);
```

### 2. アシンメトリーの活用

- **レイアウト**: 完全な中央配置を避ける（例：translateX(-48%)）
- **グリッド**: 黄金比を避ける（例：1.2fr vs 0.8fr）
- **余白**: 左右上下で微妙に異なる値
...
- **ひらがな多め**: 「わたしたち」「つくったもの」「できること」
- **敬語の柔らかさ**: 「〜します」「〜です」（堅すぎない）
- **親しみやすさ**: 「会社さん」「お手伝い」
- **絵文字の使用**: 適度に使用（📍🌱✨ など）
